...
func TestOrderedDatabaseJSON(t *testing.T) {
	...
	Then(t, "OrderedDatabase 可从 JSON 解码",
		ExpectDo(func() error {
			return jsonv2.Unmarshal(raw, &db)
		}),
	)
	Then(t, "OrderedDatabase 按输入顺序解码表、列和约束",
	...
	Then(t, "MarshalJSONTo 保留 record 顺序",
